...
plot_bias_dat %>% 
  ggplot(aes(x=k,y=bias))+
    geom_point()+
    geom_line()+
    geom_segment(aes(x = 1.97, xend = 1.97, y = -0.05, yend = 0.05), color = "red",linetype="dashed")+
    geom_segment(aes(x = 1.67, xend = 1.67, y = 0.15, yend = 0.25), color = "blue",linetype="dashed")+
